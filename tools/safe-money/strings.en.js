...
(function () {
  ...
  App.i18n.register({
    ...
    s3instr: 'You get an SMS from your "bank" with a link to "verify your account". What do you do?',
    s4instr: 'Someone calls saying they are from your bank and asks for your passwords. What do you do?',
    s5instr: 'A "family member" asks you for an urgent Bizum because of a problem. What do you do?',
    s6instr: 'You are about to buy a second-hand phone on a resale app. What do you do?',

    opLlamarBanco: '📞 I call my bank first',
    opNoGastar: '🚫 I do not spend it and I do not send it back',
    ...
    opBorrar: '🗑️ I delete the SMS and tell my bank',
    opPagarRapido: '💸 I pay quickly before the offer runs out',
    opLlamarFamiliar: '📞 I call that family member another way to confirm',
    opPedirMas: '💸 I send more money if they ask for it',
    opPagarAdelanto: '💸 I pay a deposit to "reserve" it',
    opQuedarBanco: '🏦 I meet in person and pay at the bank',
    opComprarYa: '✅ I buy it now before someone else gets it',

    s1pista: 'Money you were not expecting may be someone else\'s mistake. The first step is to call your bank, not to spend it.',
    s2pista: 'If you sent money by mistake, time matters: tell your bank as soon as you can.',
    s3pista: 'Banks never ask you to verify anything via SMS links. Be careful and check on your own.',
    s4pista: 'Your real bank already has your details. They will never ask for your passwords on the phone.',
