...
Okeymoney es una aplicación web completamente del lado del cliente: no
...
[GitHub Security Advisories](https://github.com/thenkdframe/okeymoney/security/advisories/new).
